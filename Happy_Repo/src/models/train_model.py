...
def objective(trial):
    ...
    _XGB_model = XGBClassifier(objective = 'binary:logistic', eval_metric = 'error', learning_rate = learning_rate, max_depth = max_depth, n_estimators = n_estimators, random_state = 0)
...
XGB_model = XGBClassifier(objective = 'binary:logistic', eval_metric = 'error', learning_rate = learning_rate, max_depth = max_depth, n_estimators = n_estimators, reg_lambda = reg_lambda, random_state = 0)
# XGB_model = XGBClassifier(objective = 'binary:logistic', eval_metric = 'error', learning_rate = 0.018, max_depth = 1, n_estimators = 4)
# XGB_model = XGBClassifier(objective = 'binary:logistic', eval_metric = 'error', learning_rate = 0.0575, max_depth = 3, n_estimators = 21)
